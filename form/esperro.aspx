    ...
    <div>
        <table id="Table1" border="0" cellpadding="1" cellspacing="1" height="100%" width="100%">
            <tr>
                <td align="center">
                    &nbsp;<br />
                    &nbsp;<asp:Image ID="Image1" runat="server" ImageUrl="~/imagens/erro.png" /><br />
                    <asp:TextBox ID="TextBox1" runat="server" BackColor="WhiteSmoke" BorderColor="DarkRed"
                        BorderStyle="None" Enabled="False" EnableTheming="True" Font-Size="Small" ForeColor="White"
...
A Equipe de Desenvolvimento Centec.
                    ...
                    <asp:Button ID="Button1" runat="server" BorderStyle="None" Height="24px" Text="OK"
                        Width="72px" /></td>
            </tr>
        </table>
